...
```
  [0x80]  0x26fe2  pop | over | or | .
  [0x81]  0x229b2  a | . | . | .
  [0x82]  0x1dbb2  unext | !b | . | .
...
; ---- -dac ----
  [0xbc]  0x248ba  dup | push | push | .
  [0xbd]  0x20cca  over | pop | - | .
  [0xbe]  0x3c8bf  + | push | push | @p
  [0xbf]  0x00155  (data: 341)
```
